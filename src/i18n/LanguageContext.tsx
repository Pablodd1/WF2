...
const translations: Record<Exclude<AppLanguage, 'en'>, Record<string, string>> = {
  es: {
    ...
    'Workspace': 'Espacio de trabajo', 'Authenticated posting': 'Publicación autenticada', 'WatchFacts form': 'Formulario WatchFacts',
    ...
    'Post an item.': 'Publicar un artículo.', 'Use the connected Luxury App without leaving WatchFacts.': 'Usa la aplicación Luxury conectada sin salir de WatchFacts.', 'Open full page': 'Abrir página completa',
    ...
    'Contact': 'Contacto', 'Contact WatchFacts': 'Contactar a WatchFacts', 'Questions, partnerships, listing support, or new opportunities.': 'Preguntas, alianzas, ayuda con anuncios o nuevas oportunidades.', 'Contact us on WhatsApp': 'Contáctanos por WhatsApp', 'Name': 'Nombre', 'Email': 'Correo electrónico', 'How can we help?': '¿Cómo podemos ayudarte?', 'Email destination pending': 'Destino de correo pendiente', 'The form will be activated after the receiving email or support system is confirmed.': 'El formulario se activará cuando se confirme el correo o sistema de soporte receptor.', 'Community': 'Comunidad', 'Join Our Chats': 'Únete a nuestros chats', 'Be part of our vibrant community by joining our WhatsApp and Telegram groups.': 'Forma parte de nuestra comunidad uniéndote a nuestros grupos de WhatsApp y Telegram.', 'Curated Luxury marketplace with WatchFacts market intelligence.': 'Mercado Curated Luxury con inteligencia de mercado de WatchFacts.', 'Company': 'Empresa', 'All Rights Reserved.': 'Todos los derechos reservados.'
  },
  pt: {
    'Language': 'Idioma',
    ...
    'Workspace': 'Área de trabalho', 'Authenticated posting': 'Publicação autenticada', 'WatchFacts form': 'Formulário WatchFacts', 'Direct normalized posting': 'Publicação normalizada direta', 'Photograph it. Describe it. Post it.': 'Fotografe. Descreva. Publique.',
    ...
    'Post an item.': 'Publicar um item.', 'Use the connected Luxury App without leaving WatchFacts.': 'Use o Luxury App conectado sem sair do WatchFacts.', 'Open full page': 'Abrir página completa',
    ...
    'Contact': 'Contato', 'Contact WatchFacts': 'Fale com a WatchFacts', 'Contact us on WhatsApp': 'Fale conosco pelo WhatsApp', 'Name': 'Nome', 'Email': 'E-mail', 'How can we help?': 'Como podemos ajudar?', 'Email destination pending': 'Destino de e-mail pendente', 'Community': 'Comunidade', 'Join Our Chats': 'Participe dos nossos chats', 'Be part of our vibrant community by joining our WhatsApp and Telegram groups.': 'Faça parte da nossa comunidade nos grupos de WhatsApp e Telegram.', 'Company': 'Empresa', 'All Rights Reserved.': 'Todos os direitos reservados.'
  },
  zh: {
    'Language': '语言',
    ...
    'Workspace': '工作区', 'Authenticated posting': '认证发布', 'WatchFacts form': 'WatchFacts 表单', 'Direct normalized posting': '直接规范化发布', 'Photograph it. Describe it. Post it.': '拍摄、描述、发布。',
    ...
    'Your recent posts': '最近发布', 'Published items remain available for later human quality review.': '已发布商品仍可供后续人工质量审核。', 'No posts yet.': '暂无发布。', 'Post received': '已收到发布', 'Post an item.': '发布商品。', 'Use the connected Luxury App without leaving WatchFacts.': '无需离开 WatchFacts 即可使用已连接的 Luxury App。', 'Open full page': '打开完整页面',
    ...
    'Contact': '联系', 'Contact WatchFacts': '联系 WatchFacts', 'Contact us on WhatsApp': '通过 WhatsApp 联系我们', 'Name': '姓名', 'Email': '电子邮件', 'How can we help?': '我们能为您做什么？', 'Email destination pending': '收件邮箱待确认', 'Community': '社区', 'Join Our Chats': '加入聊天群', 'Be part of our vibrant community by joining our WhatsApp and Telegram groups.': '加入我们的 WhatsApp 和 Telegram 群组，成为社区的一员。', 'Company': '公司', 'All Rights Reserved.': '版权所有。'
  },
};
