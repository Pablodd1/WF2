...
const shareText = () => encodeURIComponent('Explore WatchFacts market intelligence.');
...
export function SocialShareRail() {
  ...
  return (
    <aside className="fixed right-0 top-1/2 z-40 hidden -translate-y-1/2 border border-r-0 border-white/15 bg-black/80 sm:flex sm:flex-col" aria-label="Share WatchFacts">
